...
Begin VB.UserControl isButton 
   ...
   EndProperty
   KeyPreview      =   -1  'True
   PropertyPages   =   "isButton.ctx":0000
   ScaleHeight     =   97
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   229
   ToolboxBitmap   =   "isButton.ctx":0014
...
' Description:  Multy Style Command Button. Made from scratch, API drawn.
...
Public Property Let Drive(ByVal New_Drive As Variant)
    m_Drive = New_Drive
